 ...
 *
 */
public class SampleCreateSession {

    private MessageBusApiClient messageBusApiClient;

    public SampleCreateSession(MessageBusApiClient messageBusApiClient) {
        this.messageBusApiClient = messageBusApiClient;
    }

    public static void main(final String[] args) {

        SampleCreateSession exampleCreateSession = new SampleCreateSession(MessageBusFactory
