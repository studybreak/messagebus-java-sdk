 ...
 *
 */
public class SampleTemplateCreate {

    private MessageBusTemplatesClient messageBusTemplatesClient;

    public SampleTemplateCreate(MessageBusTemplatesClient messageBusTemplatesClient) {
        this.messageBusTemplatesClient = messageBusTemplatesClient;
    }

    public static void main(String[] args) {

        final SampleTemplateCreate exampleTemplate = new SampleTemplateCreate(MessageBusFactory.createTemplatesClient("<YOUR_API_KEY>", "https://templates.messagebus.com"));
    ...
    public void exampleCreateTemplate() {
        try {
            ...
            if (templateCreateResponse.getStatusCode() == 201) {
                ...
                for (TemplateListItemResult templateResult : templates.getTemplates()) {
