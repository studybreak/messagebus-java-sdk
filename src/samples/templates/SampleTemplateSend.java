 ...
 *
 */
public class SampleTemplateSend {

    private MessageBusTemplatesClient messageBusTemplatesClient;

    public SampleTemplateSend(MessageBusTemplatesClient messageBusTemplatesClient) {
        this.messageBusTemplatesClient = messageBusTemplatesClient;
    }

    public static void main(String[] args) {

        final SampleTemplateSend exampleTemplate = new SampleTemplateSend(MessageBusFactory.createTemplatesClient("<YOUR_API_KEY>", "https://templates.messagebus.com"));
