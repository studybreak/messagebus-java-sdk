...
public class ExampleGetChannelsSessions {

    private MessageBusApiClient messageBusApiClient;

    public ExampleGetChannelsSessions(MessageBusApiClient messageBusApiClient) {
        this.messageBusApiClient = messageBusApiClient;
    }

    public static void main(final String[] args) {

        ExampleGetChannelsSessions exampleGetChannelsSessions = new ExampleGetChannelsSessions(MessageBusFactory
