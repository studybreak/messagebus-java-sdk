...
public class StatsReportRequest {
    ...
    public StatsReportRequest(
            @JsonProperty("startDate") Date startDate,@JsonProperty("endDate") Date endDate,
            @JsonProperty("channelKey") String channelKey,@JsonProperty("sessionKey") String sessionKey,@JsonProperty("format") MessageBusReportingClient.ReportFormat format
    ) {
        initDateFormatter();
    ...
    public StatsReportRequest(
            ...
            String channelKey,MessageBusReportingClient.ReportFormat format
    ) {
        initDateFormatter();
        this.channelKey = channelKey;
        this.format=format.name();
    ...
    private final String reportType="stats";
}
